...
## Polish
- [x] [POLISH] In the TUI when wrap-up gets to running final static analyzer the text is so long it pushes all of the timings off the side of the screen in the Stage Timings column. We should either make it ellipsis sooner or make it wrap lines for long lines like that.
