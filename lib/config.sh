...
apply_milestone_overrides() {
    export MAX_REVIEW_CYCLES="$MILESTONE_MAX_REVIEW_CYCLES"
    export CODER_MAX_TURNS="$MILESTONE_CODER_MAX_TURNS"
    export JR_CODER_MAX_TURNS="$MILESTONE_JR_CODER_MAX_TURNS"
    export REVIEWER_MAX_TURNS="$MILESTONE_REVIEWER_MAX_TURNS"
    export TESTER_MAX_TURNS="$MILESTONE_TESTER_MAX_TURNS"
